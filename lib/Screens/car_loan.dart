...
import 'package:emi_calculator/Widgets/navigation_drawer_for_car_loan.dart';
...
class CarLoanHomeScreen extends StatefulWidget {
  const CarLoanHomeScreen({Key? key}) : super(key: key);

  @override
  State<CarLoanHomeScreen> createState() => _CarLoanHomeScreenState();
}

class _CarLoanHomeScreenState extends State<CarLoanHomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      endDrawer: NavigationDrawerForCarLoan(),
      appBar: AppBar(
        title: Text('Car Loan'),
        leading: IconButton(
          onPressed: () {
    ...
    return Container(
        child: canShow ? Column(
          ...
          children: [
            Text("Your Monthly EMI is",style: TextStyle(color: Colors.white),),
            Container(
              child: Text('₹21,247.04',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 25,color: Colors.white),),
            ),
          ],
        )
    );
